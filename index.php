    ...
    <main class="container">
        <nav class="row imagenes" id="imagenes">
            ...
            <section class="mujer secciones col-sm-12 col-md-4 col-lg-4">
                <a href="<?php echo $reg['link']; ?>"><img src="data:image/jpg;base64, <?php echo base64_encode($reg['imagen'])?>" alt="seccion mujer"><p><?php echo $reg['texto']; ?></p></a>          
            </section>
            <?php } ?>
        </nav>
        <hr>
